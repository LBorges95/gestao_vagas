...
import br.com.leonardo.gestao_vagas.modules.company.useCases.CreateJobUseCase;
...
public class JobController {
    ...
    @Tag(name = "Vagas", description =  "Informações de vagas")
     @Operation(summary= "Cadastro vagas disponíveis", description = "Essa função é reponsável cadastrar as vagas disponíveis em uma empresa.")
     @ApiResponses({
